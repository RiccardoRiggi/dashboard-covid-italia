...
export class StoricoRegionaleComponent implements OnInit {
  ...
  constructor(http: HttpClient,private route: ActivatedRoute) { 
    ...
    let obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-totale-casi', { responseType: 'text' });
    obs.subscribe((Response) => this.mettiJSON(Response));
    obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-terapia-intensiva', { responseType: 'text' });
    obs.subscribe((Response) => this.mettiJSONTerapiaIntensiva(Response));
    obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-totale-ospedalizzati', { responseType: 'text' });
    obs.subscribe((Response) => this.mettiJSONOspedalizzati(Response));
    obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-isolamento-domiciliare', { responseType: 'text' });
    obs.subscribe((Response) => this.mettiJSONIsolamentoDomiciliare(Response));
    obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-dimessi-guariti', { responseType: 'text' });
    obs.subscribe((Response) => this.mettiJSONGuariti(Response));
    obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-deceduti', { responseType: 'text' });
    obs.subscribe((Response) => this.mettiJSONDecessi(Response));
    obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-tamponi', { responseType: 'text' });
    obs.subscribe((Response) => this.mettiJSONTamponi(Response));
    obs = http.get(environment.url_base+'regioni/'+this.codiceRegione+'/storico-rapporto-tamponi-positivi', { responseType: 'text' });
